...
const MejorasListing = lazy(() => import('@/components/mejoras/MejorasListing'));
    ...
    <Suspense fallback={<LoadingFallback />}>
      <Routes>
        <Route path="/" element={<MenuPrincipal />}>
          ...
          {/* Rutas del Menú */}
          <Route path="mejoras" element={<MejorasListing />} />
          ...
          <Route path="mediciones" element={<MedicionesListing />} />
        ...
        {/* Aquí podrían ir rutas que no usen MenuPrincipal, como Login, etc. */}
